...
with_node \
  ...
  --target "/Users/nicosicat/Downloads/safe-scan/ios/Pods/Target Support Files/Pods-safescan/ExpoModulesProvider.swift" \
  --entitlement "/Users/nicosicat/Downloads/safe-scan/ios/safescan/safescan.entitlements" \
  --platform "apple" \
  --packages "expo" "expo-asset" "expo-barcode-scanner" "expo-blur" "expo-camera" "expo-constants" "expo-file-system" "expo-font" "expo-haptics" "expo-keep-awake" "expo-linking" "expo-router" "expo-splash-screen" "expo-symbols" "expo-system-ui" "expo-web-browser"
